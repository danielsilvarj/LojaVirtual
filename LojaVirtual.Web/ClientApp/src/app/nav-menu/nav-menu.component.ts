...
export class NavMenuComponent implements OnInit {
  ...
  isExpanded = false;
  public pCarrinhoCompras: LojaCarrinhoCompras;

  ngOnInit(): void {
    this.pCarrinhoCompras = new LojaCarrinhoCompras();
  ...
  sair(): void {
    //alert(sessionStorage.getItem("usuario-autenticado"));
  ...
  public temItensCarrinhoCompras(): boolean {
    return true; //this.pCarrinhoCompras.temItensCarrinhoCompras();
  }
